...
function print_setting_peekers()
{
	...
	<script type="text/javascript">
		...
		function loadPeekers()
		{
			...
			new Peeker(document.getElementsByClassName("setting_postfloodcheck"), $("row_setting_postfloodsecs"), /1/, true);
			...
			new Peeker(document.getElementsByClassName("setting_enablememberlist"), $("row_setting_membersperpage"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablememberlist"), $("row_setting_default_memberlist_sortby"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablememberlist"), $("row_setting_default_memberlist_order"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablereputation"), $("row_setting_repsperpage"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablewarningsystem"), $("row_setting_allowcustomwarnings"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablewarningsystem"), $("row_setting_canviewownwarning"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablewarningsystem"), $("row_setting_maxwarningpoints"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablepms"), $("row_setting_pmsallowhtml"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablepms"), $("row_setting_pmsallowmycode"), /1/, true);
			new Peeker(document.getElementsByClassName("setting_enablepms"), $("row_setting_pmsallowsmilies"), /1/, true);
