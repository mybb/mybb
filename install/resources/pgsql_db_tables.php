...
$tables[] = "CREATE TABLE mybb_adminlog (
  ...
  ipaddress bytea(16) NOT NULL default '',
...
$tables[] = "CREATE TABLE mybb_polls (
  ...
  numvotes text NOT NULL default '',
...
$tables[] = "CREATE TABLE mybb_reportedposts (
  ...
  dateline bigint NOT NULL default '0',
  lastreport bigint NOT NULL default '0',
  PRIMARY KEY (rid)
);";
...
$tables[] = "CREATE TABLE mybb_usergroups (
  ...
  canbereported int NOT NULL default '0',
...
$tables[] = "CREATE TABLE mybb_users (
  ...
  referrals int NOT NULL default '0',
  reputation bigint NOT NULL default '0',
  regip bytea(16) NOT NULL default '',
  lastip bytea(16) NOT NULL default '',
