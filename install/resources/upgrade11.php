...
var cookieDomain = "{$mybb->settings[\'cookiedomain\']}";', $template['template']);
		...
		$db->update_query(TABLE_PREFIX."templates", array('template' => $db->escape_string($template['template']), 'version' => '1212'), "tid='{$template['tid']}'", 1);
	}
