...
function upgrade51_dbchanges()
{
	...
	// Update setting values for guest group to 0
	$db->update_column("UPDATE ".TABLE_PREFIX."usergroups SET caneditposts = 0, candeleteposts = 0, candeletethreads = 0, caneditattachments = 0, canviewdeletionnotice = 0 WHERE gid = 1 ");
}
