...
class Convert_punbb extends Converter {
	...
	function import_users()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."users", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			// Get members
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."users", "*", "username != 'Guest'", array('limit_start' => $import_session['start_users'], 'limit' => $import_session['users_per_screen']));
	...
	function import_categories()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."categories", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."categories", "*", "", array('limit_start' => $import_session['start_cats'], 'limit' => $import_session['cats_per_screen']));
	...
	function import_forums()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."forums", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."forums", "*", "", array('limit_start' => $import_session['start_forums'], 'limit' => $import_session['forums_per_screen']));
	...
	function import_forumperms()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."forum_perms", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."forum_perms", "*", "", array('limit_start' => $import_session['start_forumperms'], 'limit' => $import_session['forumperms_per_screen']));
	...
	function import_threads()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."topics", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."topics", "*", "", array('limit_start' => $import_session['start_threads'], 'limit' => $import_session['threads_per_screen']));
	...
	function import_posts()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."posts", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		{	
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."posts", "*", "", array('limit_start' => $import_session['start_posts'], 'limit' => $import_session['posts_per_screen']));
			while($post = $this->old_db->fetch_array($query))
			{
				...
				$query2 = $db->simple_select(TABLE_PREFIX."threads", "*", "tid='".$this->get_import_tid($post['topic_id'])."'");
	...
	function import_usergroups()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."groups", "COUNT(*) as count");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."groups", "*", "g_id > 3", array('limit_start' => $import_session['start_usergroups'], 'limit' => $import_session['usergroups_per_screen']));
	...
	function import_settings()
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."config", "COUNT(*) as count", "conf_name IN({$settings})");
...
<p><input type=\"radio\" name=\"autorefresh\" value=\"yes\" checked=\"checked\" /> Yes <input type=\"radio\" name=\"autorefresh\" value=\"no\" /> No</p>";
		...
		else
		{
			...
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."config", "conf_name, conf_value", "conf_name IN({$settings})", array('limit_start' => $import_session['start_settings'], 'limit' => $import_session['settings_per_screen']));
	...
	{
		$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."posts", "*", "id = '{$pid}'");
	...
	{
		$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."topics", "*", "forum_id = '{$fid}'", array('order_by' => 'posted', 'order_dir' => 'DESC', 'limit' => 1));
		$thread = $this->old_db->fetch_array($query);
		
		$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."posts", "*", "topic_id = '{$thread['id']}'", array('order_by' => 'posted', 'order_dir' => 'DESC', 'limit' => 1));
		return array(
	...
	function get_group_id($gid, $not_multiple=false, $orig=false)
	{
		...
		{
			$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."groups", "COUNT(*) as rows", "g_id = '{$gid}'");
			$settings = array('limit_start' => '1', 'limit' => $this->old_db->fetch_field($query, 'rows'));
		}
		
		$query = $this->old_db->simple_select(PUNBB_TABLE_PREFIX."groups", "*", "g_id = '{$gid}'", $settings);
