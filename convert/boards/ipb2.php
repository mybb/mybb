...
class Convert_ipb2 extends Converter {
	...
	var $modules = array("db_configuration" => array("name" => "Database Configuration",
						 ...
						 "import_categories" => array("name" => "Import Invision Power Board 2 Categories",
									  "dependencies" => "db_configuration"),
	...
	function db_configuration()
	{
		...
		if($mybb->input['dbengine'])
		{
			...
			else
			{
				...
				{
					$errors[] = "The Invision Power Board table '{$mybb->input['tableprefix']}users' could not be found in database '{$mybb->input['dbname']}'.  Please ensure phpBB exists at this database and with this table prefix.";
				}
