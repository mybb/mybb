...
$l['done_step_success'] = '<p class="success">Your existing bulletin board software has been converted to MyBB.</p>
<p>The MyBB Group thanks you for your support in converting to our software and we hope to see you around the community forums if you need help or wish to become a part of the MyBB community.</p>';
$l['done_step_locked'] = '<p>Your converter has been locked. To unlock the converter please delete the \'lock\' file in this directory.</p><p>You may now proceed to your copy of <a href="../index.php">MyBB</a> or its <a href="../admin/index.php">Admin Control Panel</a>.</p>';
...
/* Error messages */
$l['locked'] = 'The converter is currently locked, please remove \'lock\' from this directory to continue';
?>