var MyBB = {
	...
	pageLoaded: function()
	{
		...
		if(typeof(use_xmlhttprequest) != "undefined" && use_xmlhttprequest == 1)
		{
			...
			{
				var element = $(this);
				if(element.hasClass('forum_off') || element.hasClass('forum_offlock') || element.hasClass('forum_offlink') || element.hasClass('subforum_minioff') || element.hasClass('subforum_miniofflock') || (element.attr("title") && element.attr("title") == lang.no_new_posts)) return;
