...
*/
(function(c){var d="",g=function(a){a=c(a);var e=this,f=c("#"+a.attr("id")+"_popup");this.open=function(b){event.preventDefault();""!=d&&e.close();b=a.offset();b.top+=a.outerHeight();f.css({display:"block",position:"absolute",top:b.top,left:b.left});d=f;c(document).mousedown(e.close)};this.close=function(b){if(b&&-1!=c(b.target).parents().index(d))return!1;c(d).css({display:"none"});d=""}};c.fn.popupMenu=function(a){return this.each(function(){var a=new g(this);c(this).click(a.open)})}})(jQuery);