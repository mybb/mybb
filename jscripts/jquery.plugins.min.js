...
*/
(function(c){var d="",g=function(a){a=c(a);var f=this,e=c("#"+a.attr("id")+"_popup");this.open=function(b){""!=d&&f.close();b=a.offset();b.top+=a.outerHeight();e.css({display:"block",position:"absolute",top:b.top,left:b.left});d=e;c(document).mousedown(f.close)};this.close=function(b){if(b&&-1!=c(b.target).parents().index(e))return!1;c(d).css({display:"none"});d=""}};c.fn.popupMenu=function(a){return this.each(function(){var a=new g(this);c(this).click(a.open)})}})(jQuery);