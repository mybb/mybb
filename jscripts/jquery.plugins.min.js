...
*/
(function(a){var d="",g=function(b){b=a(b);var e=this,f=a("#"+b.attr("id")+"_popup");this.open=function(c){event.preventDefault();""!=d&&e.close();c=b.offset();c.top+=b.outerHeight();f.css({display:"block",position:"absolute",top:c.top,left:c.left});d=f;a(document).mousedown(e.close)};this.close=function(c){if(c&&-1!=a(c.target).parents().index(d))return!1;a(d).css({display:"none"});d=""}};a.fn.popupMenu=function(b){return this.each(function(){alert(a(this).attr("id"));var b=new g(this);a(this).click(b.open)})}})(jQuery);