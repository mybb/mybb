...
if($mybb->input['action'] == "add") 
{
	...
	$startdatemonth .= "<option value=\"01\" $monthsel[01]>{$lang->month_1}</option>\n";
	$enddatemonth .= "<option value=\"01\" $monthsel[01]>{$lang->month_1}</option>\n";
	$startdatemonth .= "<option value=\"02\" $monthsel[02]>{$lang->month_2}</option>\n";
	$enddatemonth .= "<option value=\"02\" $monthsel[02]>{$lang->month_2}</option>\n";
	$startdatemonth .= "<option value=\"03\" $monthsel[03]>{$lang->month_3}</option>\n";
	$enddatemonth .= "<option value=\"03\" $monthsel[03]>{$lang->month_3}</option>\n";
	$startdatemonth .= "<option value=\"04\" $monthsel[04]>{$lang->month_4}</option>\n";
	$enddatemonth .= "<option value=\"04\" $monthsel[04]>{$lang->month_4}</option>\n";
	$startdatemonth .= "<option value=\"05\" $monthsel[05]>{$lang->month_5}</option>\n";
	$enddatemonth .= "<option value=\"05\" $monthsel[05]>{$lang->month_5}</option>\n";
	$startdatemonth .= "<option value=\"06\" $monthsel[06]>{$lang->month_6}</option>\n";
	$enddatemonth .= "<option value=\"06\" $monthsel[06]>{$lang->month_6}</option>\n";
	$startdatemonth .= "<option value=\"07\" $monthsel[07]>{$lang->month_7}</option>\n";
	$enddatemonth .= "<option value=\"07\" $monthsel[07]>{$lang->month_7}</option>\n";
	$startdatemonth .= "<option value=\"08\" $monthsel[08]>{$lang->month_8}</option>\n";
	$enddatemonth .= "<option value=\"08\" $monthsel[08]>{$lang->month_8}</option>\n";
	$startdatemonth .= "<option value=\"09\" $monthsel[09]>{$lang->month_9}</option>\n";
	$enddatemonth .= "<option value=\"09\" $monthsel[09]>{$lang->month_9}</option>\n";
	$startdatemonth .= "<option value=\"10\" $monthsel[10]>{$lang->month_10}</option>\n";
	$enddatemonth .= "<option value=\"10\" $monthsel[10]>{$lang->month_10}</option>\n";
	$startdatemonth .= "<option value=\"11\" $monthsel[11]>{$lang->month_11}</option>\n";
	$enddatemonth .= "<option value=\"11\" $monthsel[11]>{$lang->month_11}</option>\n";
	$startdatemonth .= "<option value=\"12\" $monthsel[12]>{$lang->month_12}</option>\n";
	$enddatemonth .= "<option value=\"12\" $monthsel[12]>{$lang->month_12}</option>\n";
...
if($mybb->input['action'] == "edit")
{
	...
	$startdatemonth .= "<option value=\"01\" $startmonthsel[01]>{$lang->month_1}</option>\n";
	$enddatemonth .= "<option value=\"01\" $endmonthsel[01]>{$lang->month_1}</option>\n";
	$startdatemonth .= "<option value=\"02\" $startmonthsel[02]>{$lang->month_2}</option>\n";
	$enddatemonth .= "<option value=\"02\" $endmonthsel[02]>{$lang->month_2}</option>\n";
	$startdatemonth .= "<option value=\"03\" $startmonthsel[03]>{$lang->month_3}</option>\n";
	$enddatemonth .= "<option value=\"03\" $endmonthsel[03]>{$lang->month_3}</option>\n";
	$startdatemonth .= "<option value=\"04\" $startmonthsel[04]>{$lang->month_4}</option>\n";
	$enddatemonth .= "<option value=\"04\" $endmonthsel[04]>{$lang->month_4}</option>\n";
	$startdatemonth .= "<option value=\"05\" $startmonthsel[05]>{$lang->month_5}</option>\n";
	$enddatemonth .= "<option value=\"05\" $endmonthsel[05]>{$lang->month_5}</option>\n";
	$startdatemonth .= "<option value=\"06\" $startmonthsel[06]>{$lang->month_6}</option>\n";
	$enddatemonth .= "<option value=\"06\" $endmonthsel[06]>{$lang->month_6}</option>\n";
	$startdatemonth .= "<option value=\"07\" $startmonthsel[07]>{$lang->month_7}</option>\n";
	$enddatemonth .= "<option value=\"07\" $endmonthsel[07]>{$lang->month_7}</option>\n";
	$startdatemonth .= "<option value=\"08\" $startmonthsel[08]>{$lang->month_8}</option>\n";
	$enddatemonth .= "<option value=\"08\" $endmonthsel[08]>{$lang->month_8}</option>\n";
	$startdatemonth .= "<option value=\"09\" $startmonthsel[09]>{$lang->month_9}</option>\n";
	$enddatemonth .= "<option value=\"09\" $endmonthsel[09]>{$lang->month_9}</option>\n";
	$startdatemonth .= "<option value=\"10\" $startmonthsel[10]>{$lang->month_10}</option>\n";
	$enddatemonth .= "<option value=\"10\" $endmonthsel[10]>{$lang->month_10}</option>\n";
	$startdatemonth .= "<option value=\"11\" $startmonthsel[11]>{$lang->month_11}</option>\n";
	$enddatemonth .= "<option value=\"11\" $endmonthsel[11]>{$lang->month_11}</option>\n";
	$startdatemonth .= "<option value=\"12\" $startmonthsel[12]>{$lang->month_12}</option>\n";
	$enddatemonth .= "<option value=\"12\" $endmonthsel[12]>{$lang->month_12}</option>\n";
