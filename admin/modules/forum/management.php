...
// -->
	...
	if($mybb->input['pid'] || ($mybb->input['gid'] && $mybb->input['fid']))
	{
		...
		{
			$form = new Form("index.php?module=forum-management&amp;action=permissions&amp;ajax=1&amp;pid=".$mybb->get_input('pid', 1)."&amp;gid=".$mybb->get_input('gid', MyBB::INPUT_INT)."&amp;fid=".$mybb->get_input('gid', MyBB::INPUT_INT), "post", "modal_form");
		}
