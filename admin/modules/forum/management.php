	...
	foreach($forums_by_parent[$pid] as $children)
	{
		foreach($children as $forum)
		{
			...
			if($forum['type'] == "c" && ($depth == 1 || $depth == 2))
			{
				...
				$form_container->output_cell($form->generate_text_box("disporder[".$forum['fid'].", ".$forum['disporder'].", array('class' => 'align_center', 'style' => 'width:80%')), array("class" => "align_center"));
