...
if($mybb->input['action'] == "add_post_tool")
{
	...
	$selectoptions = "<option value=\"-1\"" . (isset($do_not_split_checked) ? $do_not_split_checked : '') . ">{$lang->do_not_split}</option>\n";
	$selectoptions .= "<option value=\"-2\"" . (isset($split_same_checked) ? $split_same_checked : '') . " style=\"border-bottom: 1px solid #000;\">{$lang->split_to_same_forum}</option>\n";
