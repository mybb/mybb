...
if($mybb->input['action'] == "add")
{
	...
	$form_container->output_row($lang->theme, $lang->theme_desc, build_fs_theme_select("theme", $mybb->get_input('theme'), /*$effective_uid = */0, /*$usergroup_override = */true, /*$footer = */false, /*$count_override = */true));
...
if($mybb->input['action'] == "edit")
{
	...
	$form_container->output_row($lang->theme, $lang->theme_desc, build_fs_theme_select("theme", $spider_data['theme'], /*$effective_uid = */0, /*$usergroup_override = */true, /*$footer = */false, /*$count_override = */true));
