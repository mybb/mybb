...
if($mybb->input['action'] == "add")
{
	...
	$form_container->output_row($lang->theme, $lang->theme_desc, build_fs_theme_select("theme", $mybb->get_input('theme'), true, false, true));
...
if($mybb->input['action'] == "edit")
{
	...
	$form_container->output_row($lang->theme, $lang->theme_desc, build_fs_theme_select("theme", $spider_data['theme'], true, false, true));
