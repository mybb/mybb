...
if($mybb->input['action'] == "change")
{
	...
	if($mybb->request_method == "post")
	{
		...
		if((isset($mybb->input['upsetting']['captchaimage']) && in_array($mybb->input['upsetting']['captchaimage'], array(4, 5, 8)) && (!$mybb->input['upsetting']['recaptchaprivatekey'] || !$mybb->input['upsetting']['recaptchapublickey']))
		   || (in_array($mybb->settings['captchaimage'], array(4, 5, 8)) && (!$mybb->settings['recaptchaprivatekey'] || !$mybb->settings['recaptchapublickey']))
...
function print_setting_peekers()
{
	...
	$peekers = array(
		...
		'new Peeker($("#setting_captchaimage"), $("#row_setting_recaptchaprivatekey, #row_setting_recaptchaprivatekey"), /(4|5|8)/, false)',
