...
if($mybb->input['action'] == "change")
{
	...
	if($mybb->request_method == "post")
	{
		...
		if((isset($mybb->input['upsetting']['captchaimage']) && in_array($mybb->input['upsetting']['captchaimage'], array(4, 5, 6, 7)) && (!$mybb->input['upsetting']['captchaprivatekey'] || !$mybb->input['upsetting']['captchapublickey']))
		   || (in_array($mybb->settings['captchaimage'], array(4, 5, 6, 7)) && (!$mybb->settings['captchaprivatekey'] || !$mybb->settings['captchapublickey'])))
		{
...
function print_setting_peekers()
{
	...
	$peekers = array(
		...
		'new Peeker($("#setting_captchaimage"), $("#row_setting_captchapublickey, #row_setting_captchaprivatekey"), /(4|5|6|7)/, false)',
		'new Peeker($("#setting_captchaimage"), $("#row_setting_captchatheme"), 6, false)',
		'new Peeker($("#setting_captchaimage"), $("#row_setting_captchasize"), 6, false)',
