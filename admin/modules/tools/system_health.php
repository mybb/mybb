...
if(!$mybb->input['action'])
{
	...
	if($errors)
	{
		$page->output_error("<p><em>{$errors} {$lang->error_chmod}</span></strong> {$lang->chmod_info} <a href=\"http://docs.mybb.com/1.8/install/#file-permissions\" target=\"_blank\">MyBB Docs</a>.</em></p>");
	}
	else
	{
