...
if(!$mybb->input['action'])
{
	...
	$table->construct_header($lang->resources_team, array('width' => '15%'));
	...
	$table->construct_cell("<a href=\"http://community.mybb.com/user-24127.html\" target=\"_blank\">Conor C.</a>");
	...
	$table->construct_cell("<a href=\"http://community.mybb.com/user-14772.html\" target=\"_blank\">Jos&eacute; F.</a>");
	$table->construct_row();
	...
	$table->construct_cell("&nbsp;");
	$table->construct_cell("<a href=\"http://community.mybb.com/user-57824.html\" target=\"_blank\">Tindris</a>");
	$table->construct_cell("&nbsp;");
	$table->construct_cell("&nbsp;");
	$table->construct_row();
	...
	$table->construct_cell("&nbsp;");
	$table->construct_cell("<a href=\"http://community.mybb.com/user-26592.html\" target=\"_blank\">Jovan J.</a>");
	$table->construct_cell("&nbsp;");
	$table->construct_cell("&nbsp;");
	$table->construct_row();

	$table->construct_cell("&nbsp;");
	$table->construct_cell("<a href=\"http://community.mybb.com/user-8020.html\" target=\"_blank\">pavemen</a>");
	$table->construct_cell("&nbsp;");
	$table->construct_cell("&nbsp;");
	$table->construct_cell("&nbsp;");
	$table->construct_cell("&nbsp;");
