 ...
 *
 * $Id: credits.php 5379 2011-02-21 11:06:42Z Tomm $
 */
...
if(!$mybb->input['action'])
{
	...
	$table->construct_cell("<a href=\"http://community.mybboard.net/user-1331.html\" target=\"_blank\">Chris W B.</a>");
	...
	$table->construct_cell("<a href=\"http://community.mybboard.net/user-81.html\" target=\"_blank\">Dennis Tsang</a>");
	$table->construct_cell("&nbsp;");
	$table->construct_cell("<a href=\"http://community.mybboard.net/user-13144.html\" target=\"_blank\">DougSD</a>");
