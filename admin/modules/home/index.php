...
elseif(!$mybb->input['action'])
{
	...
	{
		$lang->new_version_available = $lang->sprintf($lang->new_version_available, "MyBB {$mybb->version}", "<a href=\"https://www.mybb.com/downloads\" target=\"_blank\">MyBB {$update_check['latest_version']}</a>");
