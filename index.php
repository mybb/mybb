...
if($mybb->settings['showwol'] != "no")
{
	...
	$lang->online_note = sprintf($lang->online_note, $onlinecount, $membercount, $anoncount, $guestcount);
...
if($mybb->settings['showindexstats'] != "no")
{
	...
	$lang->stats_posts_threads = sprintf($lang->stats_posts_threads, $stats['numposts'], $stats['numthreads']);
	$lang->stats_numusers = sprintf($lang->stats_numusers, $stats['numusers']);
	...
	$lang->stats_mostonline = sprintf($lang->stats_mostonline, $recordcount, $recorddate, $recordtime);
...
{
	global $fcache, $moderatorcache, $forumpermissions, $theme, $mybb, $mybbforumread, $settings, $mybbuser, $excols, $fcollapse, $templates, $bgcolor, $collapsed, $lang, $showdepth, $forumpass;
