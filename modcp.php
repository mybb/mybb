...
if($mybb->input['action'] == "ipsearch")
{
	...
	if($mybb->input['ipaddress'])
	{
		...
		{
			$misc_info_link = "<div class=\"float_right\">(<a href=\"javascript:MyBB.popupWindow('/modcp.php?action=iplookup&ipaddress=".htmlspecialchars_uni($mybb->input['ipaddress'])."')\">{$lang->info_on_ip}</a>)</div>";
		}
