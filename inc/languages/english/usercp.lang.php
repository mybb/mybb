...
$l['contact_field_error'] = "Sorry, but we cannot change your contact information as the ID specified is too long. You can try to use a shorter ID number which is less than 75 characters long. This error will be caused by either the Google Hangouts ID or Skype ID.";
$l['contact_field_icqerror'] = "Sorry, but we cannot change your ICQ number as the number specified is too long. You can try to use a shorter ICQ number which is less than 10 characters long.";
