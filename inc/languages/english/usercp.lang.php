...
$l['time_offset_desc'] = "Please select your time-zone from the list. GMT time now is {1}.";
$l['gmt'] = "GMT";
$l['dst'] = "Enable Daylight Savings Time correction.";
$l['board_language'] = "Board Language";
$l['dst_desc'] = "If you are in a time-zone where DST currently applies you can set it here. If the clock appears an hour out, set it back.";
...
$l['error_alreadyingroup'] = "The user specified already is part of the user group.";
