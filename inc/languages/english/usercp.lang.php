...
$l['nav_options'] = "Preferences";
$l['nav_email'] = "Email Address";
$l['nav_password'] = "Password";
$l['nav_changename'] = "Username";
...
$l['current_buddies'] = "Your Buddy List";
...
$l['current_ignored_users'] = "Ignored Users";
$l['online'] = "Online";
$l['offline'] = "Offline";
...
$l['edit_sig_note2'] = "Smilies are {1} &mdash; MyCode is {2} &mdash; [img] tags are {3} &mdash; HTML is {4} &mdash; Maximum length is {5} characters";
...
$l['edit_options'] = "Edit Preferences";
...
$l['update_options'] = "Update Preferences";
...
$l['pending_invitation'] = "You have been invited to this group.";
$l['accept_invite'] = "Accept Invite";
...
$l['group_join_requestsent'] = "Your join request has been successfully sent. Once your membership is approved you will be automatically joined to this user group.<br />You will now be taken to the group memberships page.";
...
$l['attachments_deleted'] = "The selected attachments have been successfully deleted.<br />You will now be redirected to the attachments manager.";
...
$l['redirect_subscriptionsremoved'] = "Your thread subscriptions list has been cleared.<br />You will now be returned to the thread subscriptions list.";
$l['redirect_forumsubscriptionsremoved'] = "Your forum subscriptions list has now been cleared.<br />You will now be returned to where you came from.";
...
$l['redirect_optionsupdated'] = "You have successfully updated your options.<br />You will now be returned to the edit options page.";
$l['redirect_subscriptionremoved'] = "The selected thread has been removed from your subscriptions list.<br /> You will now be returned to the thread subscriptions list.";
$l['redirect_sigupdated'] = "Your signature has been successfully updated.<br />You will now be returned to the signature settings.";
$l['redirect_notepadupdated'] = "Your personal notepad has been updated.<br />You will now be returned to the User CP.";
$l['redirect_profileupdated'] = "Your profile has been successfully updated.<br />You will now be returned to the profile settings.";
...
$l['redirect_namechanged'] = "Your name has been successfully changed.<br />You will now be returned to the username settings.";
$l['redirect_emailupdated'] = "Your email address has been successfully updated.<br />You will now be returned to the email settings.";
$l['redirect_passwordupdated'] = "Your password has been successfully updated.<br />You will now be returned to the password settings.";
...
$l['redirect_avatarupdated'] = "Your avatar has been successfully changed.<br />You will now be returned to the avatar settings.";
...
$l['redirect_subscriptions_updated'] = "The selected subscriptions have been updated.<br />You will now be returned to the thread subscriptions list.";
...
$l['decline'] = 'Decline';
$l['cancel'] = 'Cancel';
$l['no_requests'] = 'No pending requests.';
