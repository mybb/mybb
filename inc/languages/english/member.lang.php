...
$l['confirm_email_desc'] = "Please enter your email address twice for confirmation.";
...
$l['confirm_password_desc'] = "Please enter your password twice for confirmation.";
$l['referrer'] = "Referrer";
...
$l['admin_edit_in_acp'] = "Edit User in Admin CP";
$l['admin_ban_in_acp'] = "Ban User in Admin CP";
...
$l['js_validator_no_security_question'] = "You need to enter the answer to the security question above";
...
$l['remove_from_buddy_list'] = "Remove Buddy";
$l['add_to_buddy_list'] = "Add Buddy";
$l['remove_from_ignore_list'] = "Stop Ignoring";
$l['add_to_ignore_list'] = "Ignore User";
