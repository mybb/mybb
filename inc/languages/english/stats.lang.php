...
$l['todays_top_poster'] = "Today's top poster: <strong>{1}</strong> (<strong>{2}</strong> posts)";
$l['popular_forum'] = "Most popular forum: <strong>{1}</strong> (<strong>{2}</strong> posts, <strong>{3}</strong> threads)";
