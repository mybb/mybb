...
$l['todays_top_poster'] = "Today's top poster";
$l['todays_top_poster_value'] = "{1} ({2} posts)";
$l['popular_forum'] = "Most popular forum";
$l['popular_forum_value'] = "{1} ({2} posts, {3} threads)";
...
$l['replies'] = "replies";
$l['views'] = "views";
$l['top_referrer'] = "Top referrer";
$l['top_referrer_value'] = "{1} ({2} referrals)";
