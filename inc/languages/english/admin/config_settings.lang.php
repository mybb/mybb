...
$l['success_settings_updated_username_method_conflict'] = '<div class="smalltext" style="font-weight: normal;">Please note that the <strong>Allowed Login Methods</strong> setting was not updated due to emails to be registered multiple times is allowed currently.</div>';
$l['success_settings_updated_username_method'] = '<div class="smalltext" style="font-weight: normal;">Please note that the <strong>Allowed Login Methods</strong> setting was not updated due to multiple users using the same e-mail address at this time.</div>';
$l['success_settings_updated_allowmultipleemails'] = '<div class="smalltext" style="font-weight: normal;">Please note that the <strong>Allow emails to be registered multiple times?</strong> setting can\'t be enabled because the <strong>Allowed Login Methods</strong> setting allows users to login by e-mail address.</div>';
