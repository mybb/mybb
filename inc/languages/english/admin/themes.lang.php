...
$l['form_elements'] = "Form Elements (Textboxes, Textareas, Drop-downs, Radio Buttons, Checkboxes) ";
...
$l['version_warning'] = "The theme file is not for the current version of myBB you are running ($mybboard[internalver]). If you still wish to install it, please change 'Ignore Version Compatibility' to yes.";
