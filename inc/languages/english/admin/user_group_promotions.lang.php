...
$l['post_count_desc'] = "Enter the number of threads required. Thread count must be selected as a required value for this to be included. Select the type of comparison for threads.";
$l['hours'] = "Hours";
$l['days'] = "Days";
$l['weeks'] = "Weeks";
$l['months'] = "Months";
...
$l['time_online_desc'] = "Enter the number of hours, days, weeks, months, or years that this user must have been on-line for. Time on-line must be selected as a required value for this to be included. Select whether the time spend on-line should be counted in hours, days, weeks, months, or years.";
