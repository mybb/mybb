...
$l['success_group_created_duplicate_title'] = "The new user group has been created successfully. Please note: there are multiple user groups named \"{1}\", you may want to rename them to avoid confusion.";
$l['success_group_updated_duplicate_title'] = "The selected user group has been updated successfully. Please note: there are multiple user groups named \"{1}\", you may want to rename them to avoid confusion.";
