...
$l['error_cannot_delete_self'] = "You are not allowed to delete your own account.";
...
$l['editor_mode'] = "Post editor mode";
$l['editor_mode_source'] = "Source mode";
$l['editor_mode_wysiwyg'] = "WYSIWYG mode";
$l['theme'] = "Theme";
...
$l['contact_fields_match'] = "Where contact fields match…";
