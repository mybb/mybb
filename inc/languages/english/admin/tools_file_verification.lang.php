...
$l['file_verification_checksums_missing'] = 'Could not verify files because the <code>{1}</code> file is missing. You can download the file from an <a href="https://mybb.com/download" target="_blank" rel="noopener">original MyBB package</a>. This file may not be included in development-only versions.';
$l['file'] = "File";
