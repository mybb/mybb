...
$l['mime_type_desc'] = "Enter the MIME type sent by the server when downloading files of this type (<a href=\"https://www.iana.org/assignments/media-types/media-types.xhtml\">See a list here</a>)";
