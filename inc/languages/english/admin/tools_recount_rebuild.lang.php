...
$l['recount_stats_desc'] = "This will recount and update your forum statistics on the forum index and statistics pages. In order for proper statistics to be counted you should run all other Recount and Rebuild Tools prior to running this.";
...
$l['rebuild_thread_counters_desc'] = "When this is run, the post/view counters and last post of each thread will be updated to reflect the correct values. Before you run this, you should run Rebuild Forum Counters.";
$l['recount_user_posts'] = "Recount User Post Counts";
$l['recount_user_posts_desc'] = "When this is run, the post count for each user will be updated to reflect its current live value based on the posts in the database, and forums that have post count disabled. Before you run this, you should run Rebuild Thread Counters.";
