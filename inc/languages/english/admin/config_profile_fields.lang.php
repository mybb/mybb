...
$l['display_on_postbit_desc'] = "Should this field be displayed on the postbit of a user? Note that this does not apply if the field is hidden or is a text area.";
