...
$l['delete_note2'] = "<strong>Note:</strong> Once this poll has been deleted there is no way of restoring it.";
...
$l['option_multiple'] = "<strong>Allow multiple choice:</strong> Users have the ability to vote on more than one option.";
$l['option_multiple_maxoptions'] = "Maximum number of options per user (0 for no limit):";
$l['option_public'] = "<strong>Public Poll:</strong> Give users the ability to see which user voted on which option(s).";
$l['option_closed'] = "<strong>Poll is Closed:</strong> If checked the poll will be closed from voting.";
