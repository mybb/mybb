...
$l['mcp_nav_modqueue_deleted_threads'] = "Deleted Thread Moderation Queue";
$l['mcp_nav_modqueue_deleted_posts'] = "Deleted Post Moderation Queue";
...
$l['number_awaiting'] = "awaiting moderation";
$l['latest'] = "Latest";
$l['none'] = "None";
...
$l['custom_usertitle_note'] = "Here you can assign a custom user title which will overwrite the one based on users display group. Leave blank to use the current user title.";
...
$l['deleted_threads_moderation_queue'] = "Soft Deleted Threads";
$l['deleted_posts_moderation_queue'] = "Soft Deleted Posts";
...
$l['threads'] = "Threads";
$l['posts'] = "Posts";
$l['deleted_threads'] = "Deleted Threads";
$l['deleted_posts'] = "Deleted Posts";
$l['filename'] = "Filename";
...
$l['mark_all_restored'] = "Mark all for restoration";
$l['meta_forum'] = "Forum:";
...
$l['mod_queue_deleted_threads_empty'] = "The deleted threads moderation queue is currently empty.";
$l['mod_queue_deleted_posts_empty'] = "The deleted posts moderation queue is currently empty.";
...
$l['redirect_softdeletedthreadsrestored'] = "The selected threads have been restored.";
$l['redirect_softdeletedthreadsdeleted'] = "The selected threads have been deleted permanently.";
$l['redirect_softdeletedthreadsprocessed'] = "The selected threads have been processed.";
$l['redirect_softdeletedthreadsnothing'] = "No threads were changed.";
$l['redirect_softdeletedpostsrestored'] = "The selected posts have been restored.";
$l['redirect_softdeletedpostsdeleted'] = "The selected posts have been deleted permanently.";
$l['redirect_softdeletedpostsprocessed'] = "The selected posts have been processed.";
$l['redirect_softdeletedpostsnothing'] = "No posts were changed.";
...
$l['multi_restore_threads'] = "Selected Threads Restored";
...
$l['sortby_date'] = "Sort by: Date";
$l['sortby_username'] = "Sort by: Username";
$l['sortby_regdate'] = "Sort by: Registration Date";
$l['sortby_lastvisit'] = "Sort by: Last Visit";
$l['sortby_postnum'] = "Sort by: Post Count";
$l['sortby_forum_name'] = "Sort by: Forum Name";
$l['sortby_thread_subject'] = "Sort by: Thread Subject";
$l['sortby_issued_by'] = "Sort by: Issued By";
$l['sortby_issued_date'] = "Sort by: Issued Date";
$l['sortby_expiry_date'] = "Sort by: Expiry Date";
...
$l['suspend_avatar'] = "Suspend this user's avatar";
...
$l['suspendavatar_for'] = "Suspended until {1}.<br />Untick this option to remove, or extend below.";
...
$l['suspendavatar_perm'] = "Suspended permanently.<br />Untick this option to remove, or change below.";
...
$l['time'] = "Time";
$l['end_date'] = "End Date";
$l['end_date_option'] = "Select a Date";
$l['never'] = "Never";
...
$l['you_cannot_moderate_deleted_threads'] = "You do not have sufficient permission to moderate deleted threads.";
$l['you_cannot_moderate_deleted_posts'] = "You do not have sufficient permission to moderate deleted posts.";
