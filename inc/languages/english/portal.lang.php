...
$l['pms_received_new'] = "{1}, you have <strong>{2}</strong> unread message(s).";
...
$l['online_users'] = "There are currently <strong>{1}</strong> online users.";
$l['online_counts'] = "<strong>{1}</strong> Member(s) | <strong>{2}</strong> Guest(s)";
