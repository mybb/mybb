...
$l['purgespammer_desc'] = "An option will be pre-selected if there is something for it to delete/remove. If an option will not delete or remove anything (i.e. there is nothing for it to delete/remove), it will be disabled. A number in brackets indicates how many items will be deleted.";
$l['purgespammer_actionstotake'] = "Actions to take on {1}";
$l['purgespammer_deletethreads'] = "Delete Threads";
$l['purgespammer_deletethreads_desc'] = "Delete all threads this user has started.";
$l['purgespammer_deleteposts'] = "Delete Posts";
$l['purgespammer_deleteposts_desc'] = "Delete all posts this user has made.";
$l['purgespammer_removesig'] = "Remove Signature";
$l['purgespammer_removesig_desc'] = "Remove this user's signature to remove spam links etc.";
$l['purgespammer_removeavatar'] = "Remove Avatar";
$l['purgespammer_removeavatar_desc'] = "Remove this user's avatar.";
$l['purgespammer_clearprofile'] = "Clear Out Profile";
$l['purgespammer_clearprofile_desc'] = "Clear out any profile fields the user may have filled out, such as the Homepage and Bio sections.";
$l['purgespammer_deletepms'] = "Delete Private Messages";
$l['purgespammer_deletepms_desc'] = "Delete any private messages that this user may have sent to people (or received in return).";
$l['purgespammer_deletereps'] = "Delete Reputation";
$l['purgespammer_deletereps_desc'] = "Delete any reputations that the user has given or received.";
$l['purgespammer_deletereportedposts'] = "Delete Reported Posts";
$l['purgespammer_deletereportedposts_desc'] = "Delete any post reports the user has made. This will <strong>not</strong> delete the actual post that has been reported.";
$l['purgespammer_deleteevents'] = "Delete Calendar Events";
$l['purgespammer_deleteevents_desc'] = "Delete any events this user has added to the calendar.";
$l['purgespammer_ban'] = "Ban User";
$l['purgespammer_ban_desc'] = "Ban this user permanently. This will also ban the spammer's IP address.";
$l['purgespammer_ban_reason'] = "Ban Reason";
$l['purgespammer_ban_reason_desc'] = "The ban reason that will be shown to the user. Will only be used if the above option is ticked.";
$l['purgespammer_ban_reason_reason'] = "Spam";
$l['purgespammer_delete'] = "Delete User";
$l['purgespammer_delete_desc'] = "Completely delete this user.";
...
$l['purgespammer_submit'] = "Goodbye Spammer!";
