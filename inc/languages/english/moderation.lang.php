...
$l['purgespammer_deletethreads_desc'] = "Deletes all threads this user has started.";
$l['purgespammer_deleteposts'] = "Delete Posts";
$l['purgespammer_deleteposts_desc'] = "Deletes all posts this user has made.";
$l['purgespammer_removesig'] = "Remove Signature";
$l['purgespammer_removesig_desc'] = "Removes this user's signature to remove spam links etc.";
$l['purgespammer_removeavatar'] = "Remove Avatar";
$l['purgespammer_removeavatar_desc'] = "Removes this user's avatar.";
...
$l['purgespammer_deletepms_desc'] = "Deletes any private messages that this user may have sent to people (or received in return).";
$l['purgespammer_deletereps'] = "Delete Reputation";
$l['purgespammer_deletereps_desc'] = "Deletes any reputations that the user has given or received.";
$l['purgespammer_deletereportedposts'] = "Delete Reported Posts";
$l['purgespammer_deletereportedposts_desc'] = "Deletes any post reports the user has made. This will <strong>not</strong> delete the actual post that has been reported.";
$l['purgespammer_deleteevents'] = "Delete Calendar Events";
$l['purgespammer_deleteevents_desc'] = "Deletes any events this user has added to the calendar.";
