...
$l['merge_with_note'] = "Copy the URL of the thread to be merged into this one into the textbox below. The thread below will be deleted and all posts will be merged into this one.";
$l['merge_posts'] = "Merge Posts";
$l['merge_posts_note'] = "All selected posts will be merged into the first selected post.";
$l['merge_options'] = "Merge Options";
$l['posts_to_merge'] = "Posts to Merge";
$l['move_copy_thread'] = "Move / Copy Thread";
$l['new_forum'] = "New Forum";
$l['method'] = "Method";
$l['method_move'] = "Move thread";
$l['method_move_redirect'] = "Move thread and leave redirect in existing forum for:";
$l['method_move_redirect_days'] = "days";
$l['redirect_expire_note'] = "(Leave blank for indefinite redirect)";
...
$l['move_post_note'] = "Copy the URL of the thread to move these posts to into the textbox below.";
...
$l['mod_logs'] = "Recent Moderator Actions";
