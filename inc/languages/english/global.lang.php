...
$l['welcome_register'] = "Sign Up";
$l['welcome_open_buddy_list'] = "Buddy List";
$l['welcome_newposts'] = "New Posts";
$l['welcome_todaysposts'] = "Today's Posts";
$l['welcome_pms'] = "Messenger";
...
$l['upload_attachments'] = "Upload Attachments";
...
$l['pending_joinrequest'] = "Group Leader Notice: 1 pending group membership join request.";
$l['pending_joinrequests'] = "Group Leader Notice: {1} pending group membership join requests.";
...
$l['powered_by'] = "Forum software by";
$l['powered_by_desc'] = "The best free and open source forum software";
