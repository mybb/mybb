...
$l['user_stars_desc'] = "If you enter a number of stars and the location of a star image, this star image will be shown for this particular user group.";
...
$l['forum_team'] = "Show on 'Forum Team' page";
$l['is_banned_group'] = "Is banned group?<br /><small>If this group is a 'banned' user group, users will be able to be 'banned' in to this user group.</small>";
$l['publicly_joinable_options'] = "Publicly Joinable Options";
$l['user_joinable'] = "Users can join this group";
$l['moderate_join_requests'] = "Moderate all new join requests";
$l['can_set_as_display_group'] = "Users can set this group as their display group<br /><small>If set to yes, users will be able to set this user group as their display group for user titles, stars, name style and group images.</small>";
$l['moderation_administration_options'] = "Moderation/Administration Options";
$l['is_super_mod'] = "Is Super Moderator";
$l['can_access_mod_cp'] = "Can access Moderator CP";
$l['can_access_admin_cp'] = "Can access Admin CP";
...
$l['error_invalid_user_group'] = "You have specified an invalid user group.";
...
$l['success_group_deleted'] = "The specified user group has successfully been deleted.";
$l['success_groups_disporder_updated'] = "The user group display orders have been updated successfully.";
$l['success_join_request_approved'] = "The join request has been successfully approved. The user is now a member of this user group.";
$l['success_join_request_denied'] = "The join request has been successfully denied.";
$l['success_selected_requests_approved'] = "The selected join requests have been approved. The users are now part of this group.";
$l['success_selected_requests_denied'] = "The selected join requests have been denied.";
$l['success_user_made_leader'] = "was successfully made a group leader for this user group.";
$l['success_group_leader_updated'] = "The group leader has been updated successfully.";
$l['success_group_leader_deleted'] = "The user has been successfully removed from the group leaders list for this group.";
