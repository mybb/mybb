...
$l['promo_requirements_desc'] = "Select which values must be met for this promotion. Holding down CTRL selects multiple weekdays. Select 'Every weekday' if you want this task to run each weekday or you have entered a predefined day above. Select the type of comparision for posts.";
...
$l['user_group_change_type_desc'] = "Select 'Primary User Group' if the user should have their primary user group changed to the new user group. Select 'Additional User Group' if the user should have the new user group added as an additional user group to their profile.";
$l['enabled'] = "Enabled?";
