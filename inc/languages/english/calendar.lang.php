...
$l['private_option'] = "<strong>Private:</strong> Only you will be able to view this event. (Registered Users Only).";
$l['delete_option'] = "<strong>Delete:</strong> Delete this event.";
...
$l['delete_2'] = "<strong>Note:</strong> This process cannot be undone.";
