...
$tables[] = "CREATE TABLE mybb_users (
	...
	unacknowledgedwarnings int NOT NULL default '0',
	...
	suspendavatartime int NOT NULL default '0',
...
$tables[] = "CREATE TABLE mybb_warnings (
	...
	requiresacknowledgement smallint NOT NULL default '1',
...
$tables[] = "CREATE TABLE mybb_oauth_states (
    ...
    provider_identifier text NOT NULL,
    state_code int default,
	pkce_code text NOT NULL,
    created_at int,
);";
